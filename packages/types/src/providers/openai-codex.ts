...
export const openAiCodexModels = {
	...
	"gpt-5.6-sol": {
		...
		supportsVerbosity: true,
		supportsTemperature: false,
		description: "GPT-5.6 Sol: OpenAI's flagship model via ChatGPT subscription",
	},
	"gpt-5.6-terra": {
		maxTokens: 128000,
		contextWindow: 372000,
		...
		supportsVerbosity: true,
		supportsTemperature: false,
		description: "GPT-5.6 Terra: Balanced everyday model via ChatGPT subscription",
	},
	"gpt-5.6-luna": {
		maxTokens: 128000,
		contextWindow: 372000,
		...
		supportsVerbosity: true,
		supportsTemperature: false,
		description: "GPT-5.6 Luna: Fast, affordable model via ChatGPT subscription",
	},
	"gpt-5.1-codex-max": {
		maxTokens: 128000,
